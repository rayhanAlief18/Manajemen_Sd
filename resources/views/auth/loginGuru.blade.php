...
<body class="hold-transition login-page bg-sby">
    <div class="login-box">
        ...
        color: #fff;">
            <div class="p-3" style="">
                <p class="login-box-msg">Form Login <span class="text-warning">(Guru)</span></p>

                <form action="{{ route('loginGuruExecute') }}" method="POST">
                    @csrf
                ...
                <div class="register-link text-center">
                    <p>Login sebagai <a href="{{ url('/loginWali') }}" class="text-warning">Wali Murid</a></p>
                </div>
