...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid d-flex flex-row w-100" style="gap:2rem">
                <div class="card w-100">
                    ...
                    <div class="card-body row justify-content-between">
                        ...
                        <div class="col-md-2">
                            <p>Total Sakit </p>
                            <p>{{ $TotalPertemuanSakit }} / {{ $TotalPertemuan }} ({{ $PresentaseSakit }}%)</p>
                        </div>
                        <div class="col-md-2">
                            <p>Total Izin</p>
                            <p>{{ $TotalPertemuanIzin }} / {{ $TotalPertemuan }} ({{ $PresentaseIzin }}%)</p>
