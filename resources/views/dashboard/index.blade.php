                ...
                <div class="w-full col-md-12 row">
                    <div class="col-md-4 col-12 card  flex-row justify-content-center d-none d-md-flex "
                        ...
                        <div class="flex-shrink-0" style="margin-left:-7px;">
                            <img src="{{ asset('storage/guru/' . Auth::guard('guru')->user()->foto) }}"
                                alt="Generic placeholder image" class="img-fluid" style="width: 180px; border-radius:5px;">
                        </div>
                    ...
                    <div class=" col-md-4 col-12">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ route('absensi.index') }}" class="small-box-footer">Lihat Data <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class=" col-md-4 col-12">
                        ...
                        <div class="small-box bg-purple">
                            ...
                            <a href="{{ route('nilai.index') }}" class="small-box-footer">Lihat Data <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
