                ...
                <div class="card">
                    <div class="card-header d-flex">
                        <a href="{{ route('siswa.create') }}" class="btn btn-primary"><i class="mr-2 fas fa-user-plus"></i>
                            Tambah Data</a>
                        <button type="button" class="btn btn-info btn-sm ml-auto" data-toggle="modal" data-target="#NaikKelas">
                            Naik Kelas
                        </button>
                    </div>

                    {{-- MODAL --}}
                    <div class="modal fade m-0" data-keyboard="false" data-backdrop="static" id="NaikKelas" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-md" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="showModalLabel">Yakin Naik Kelas / Ganti Semester semua siswa?</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="p-4">
                                    <form class="d-flex justify-content-between align-content-center" method="POST" action="{{ route('siswa.update-semester') }}">
                                        @csrf
