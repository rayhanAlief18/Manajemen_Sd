                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        @if (Auth::guard('waliMurid')->check())
                            <h1 class="m-0">Selamat datang : {{ Auth::guard('waliMurid')->user()->wali_siswa }}</h1>
                        @endif
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                ...
                <div class="w-full col-md-12 row">
                        <div class="col-md-4 col-12 card  flex-row justify-content-center d-none d-md-flex" style="border-radius: 5px;">
                            ...
                            <div class="mt-3 flex-grow-1 ms-3 ml-4">
                    ...
                    <div class=" col-md-4 col-12">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                ...
                                <p>Data Rekap Absensi Siswa <br> {{ Auth::guard('waliMurid')->user()->nama_siswa }}</p>
                            </div>
                            <div class="icon">
