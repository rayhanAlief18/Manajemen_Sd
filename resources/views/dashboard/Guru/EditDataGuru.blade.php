                        ...
                        <div class="card-body row ">
                            ...
                            <div class="col-md-6 row ">
                                ...
                                <div class="form-group col-md-5 ">
                                    ...
                                    <input type="password" name="password" class="form-control" id="exampleInputEmail1"
                                        placeholder="Masukkan Password..." value="{{ $DataGuru->password }}">
                                    @error('password')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input type="number" name="nomor_telepon" class="form-control" id="exampleInputEmail1"
                                        placeholder="Masukkan Nomor Telepon..." value="{{ $DataGuru->nomor_telepon }}">
                                    @error('nomor_telepon')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 row  mt-2">
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <span class="note" style="color: red; font-size: 13px; font-style: italic;">note:
                                        harus terdiri dari 16 digit angka</span>
                            ...
                            <div class="col-md-12 row ">
                                <div class="form-group col-md-4 ">
                                    ...
                                    <select name="level" class="custom-select form-control" id="level">
                                        <option readonly selected>Masukkan Peran Pengguna...</option>

                                        <option value="tata usaha"
                                            {{ $DataGuru->level == 'tata usaha' ? 'selected' : '' }}>
                                            Tata Usaha
                                        </option>
                                        <option value="wali kelas"
                                            {{ $DataGuru->level == 'wali kelas' ? 'selected' : '' }}>
                                            Wali Kelas
                                        </option>
                                    </select>
                                    @error('level')
                                        ...
                                        @foreach ($kelas as $class)
                                            @if ($class->angka_kelas < 7)
                                                <option value="{{ $class->id }}"
                                                    {{ $DataGuru->angka_kelas == $class->id ? 'selected' : '' }}>
                                                    {{ $class->angka_kelas }}</option>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="status" class="custom-select form-control" id="exampleSelectBorder">
                                        ...
                                        <option value="non aktif"
                                            {{ $DataGuru->status == 'non aktif' ? 'selected' : '' }}>
                                            Non Aktif
                                        </option>
                                    </select>
                                    @error('status')
