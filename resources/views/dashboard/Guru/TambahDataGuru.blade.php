                            ...
                            <div class="col-md-6 row ">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <input type="date" name="tanggal_lahir" class="form-control" id="exampleInputEmail1"
                                        placeholder="Masukkan Data Tanggal Lahir..." value="{{old('tanggal_lahir')}}">
                                    @error('tanggal_lahir')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input type="number" name="nomor_telepon" class="form-control"
                                        id="exampleInputEmail1" placeholder="Masukkan Nomor Telepon..." value="{{old('nomor_telepon')}}">
                                        @error('nomor_telepon')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 row  mt-2">
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input type="text" name="gelar_depan" class="form-control"
                                        id="exampleInputEmail1" placeholder="Masukkan Gelar Depan..." value="{{old('gelar_depan')}}">
                                        @error('gelar_depan')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group col-md-12 ">
                                    ...
                                    <input type="text" name="gelar_belakang" class="form-control"
                                        id="exampleInputEmail1" placeholder="Masukkan Gelar Belakang..." value="{{old('gelar_belakang')}}">
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input type="number" name="tahun_lulus" class="form-control"
                                        id="exampleInputEmail1" placeholder="Masukkan Tahun Lulus..." value="{{old('tahun_lulus')}}">
                                        @error('tahun_lulus')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                </div>
                            ...
                            <div class="col-md-12 row ">
                                    <div class="form-group col-md-4 ">
                                        ...
                                        <select name="level" class="custom-select form-control"
                                                ...
                                                <option value="kepala sekolah" {{ old('level') == 'kepala sekolah' ? 'selected' : '' }}>Kepala Sekolah</option>
                                                <option value="tata usaha" {{ old('level') == 'tata usaha' ? 'selected' : '' }}>Tata Usaha</option>
                                                <option value="wali kelas" {{ old('level') == 'wali kelas' ? 'selected' : '' }}>Wali Kelas</option>
                                                <option value="guru mapel" {{ old('level') == 'guru mapel' ? 'selected' : '' }}>Guru Mapel</option>
                                            </select>
                                            @error('level')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
