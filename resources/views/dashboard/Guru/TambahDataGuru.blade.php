            ...
            <div class="col-md-12">
              ...
              <div class="col-md-6 row ">
                ...
                <div class="form-group col-md-5 mt-2">
                  ...
                  <input type="text" name="nama_guru" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama...">
              </div>
              <div class="form-group col-md-6">
                <label for="exampleInputEmail1">Tempat Lahir</label>
                <input type="text" name="tempat_lahir" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Data Tempat Lahir...">
            </div>
            <div class="form-group col-md-5">
              <label for="exampleInputEmail1">Tanggal Lahir</label>
              <input type="date" name="tanggal_lahir" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Data Tanggal Lahir...">
           </div>
            <div class="form-group col-md-6">
              <label for="exampleInputEmail1">NIK</label>
              <input type="text" name="nik" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Data NIK...">
            </div>
            <div class="form-group col-md-5">
              <label for="exampleInputEmail1">No. KK</label>
              <input type="text" name="no_kk" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Data Nomor KK...">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-5">
              ...
              <div class="col-md-6 row  mt-2">
                ...
                <div class="form-group col-md-12 ">
                  ...
                  <input type="text" name="nomor_npwp" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nomor NPWP...">
                </div>

                <div class="form-group col-md-6 ">
                  <label for="exampleInputEmail1">Gelar Depan</label>
                  <input type="text" name="gelar_depan" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Gelar Depan...">
                </div>
                <div class="form-group col-md-6 ">
                  <label for="exampleInputEmail1">Gelar Belakang</label>
                  <input type="text" name="gelar_belakang" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Gelar Belakang...">
                </div>
                <div class="form-group col-md-6 ">
                  <label for="exampleInputEmail1">Nomor Telepon</label>
                  <input type="number" name="nomor_telepon" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nomor Telepon...">
                </div>
                <div class="form-group col-md-6 ">
                  <label for="exampleInputEmail1">Nomor Hp</label>
                  <input type="number" name="nomor_hp" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nomor Hp...">
                </div>
                ...
                <div class="form-group col-md-6 ">
                  ...
                  <input type="text " name="jenjang" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Jenjang...">
                </div>
                <div class="form-group col-md-6 ">
                  <label for="exampleInputEmail1">Tahun Lulus</label>
                  <input type="number" name="tahun_lulus" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Tahun Lulus...">
                </div>
                <div class="form-group col-md-12 ">
                  <label for="exampleInputEmail1">Jurusan</label>
                  <input type="text" name="jurusan" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Jurusan...">
                </div>
