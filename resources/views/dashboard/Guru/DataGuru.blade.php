                                                        ...
                                                        <div class="card-body row p-4">
                                                            <div class="form-group col-sm-3">
                                                                <img id="previewFoto{{ $guru->id }}"
                                                                    src="{{ asset('storage/guru/' . $guru->foto) }}"
                                                                    alt="Foto Siswa"
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                              ...
                                                              <div class="form-group">
                                                                <label
                                                                    for="jenis_kelamin{{ $guru->id }}">Jenis Kelamin</label>
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                              ...
                                                              <div class="form-group">
                                                                  <label for="tanggal_lahir{{ $guru->id }}">Nomor Telepon</label>
                                                                  <p>{{ $guru->nomor_telepon }}</p>
                                                              </div>
                                                              <div class="form-group">
                                                                <label for="tanggal_lahir{{ $guru->id }}">Nomor Hp</label>
                                                                <p>{{ $guru->nomor_hp }}</p>
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                ...
                                                                <div class="form-group">
                                                                  <label for="nisn{{ $guru->id }}">NO. NPWP (Nomor Pokok Wajib Pajak)</label>
                                                                  <p>{{ $guru->nomor_npwp }}</p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="p-4 row col-md-12">
                                                              <div class="form-group col-sm-4">
                                                                <div class="form-group">
                                                                  <label for="nisn{{ $guru->id }}">Jenjang Pendidikan Terakhir</label>
                                                                  <p>{{ $guru->jenjang }}</p>
                                                                </div>
                                                                <div class="form-group">
                                                                  <label for="nisn{{ $guru->id }}">Tahun Lulus</label>
                                                            ...
                                                            <div class="form-group col-sm-4">
                                                              <div class="form-group">
                                                                <label for="nisn{{ $guru->id }}">Gelar Depan</label>
                                                                <p>{{ $guru->gelar_belakang }}</p>
                                                              </div>
                                                              <div class="form-group">
                                                                <label for="nisn{{ $guru->id }}">Gelar Belakang</label>
                                                                <p>{{ $guru->gelar_belakang}}</p>
                                                              </div>
                                                              <div class="form-group">
                                                                <label for="nisn{{ $guru->id }}">Jurusan</label>
                                                              ...
                                                              <div class="form-group col-sm-4">
                                                                ...
                                                                @if($guru->jabatan == 'guru wali kelas')
                                                                <div class="form-group">
                                                                  <label for="wali_siswa{{ $guru->id }}">Kelas Yang Diampu</label>
